...
- 代码死缓：`watchdog.mjs`、`flow.mjs`、`guard-keepalive.mjs`、`scripts/lib/guard-*`、`board-hook.mjs`、`cursor-context-hook.mjs` 由 #807 其它块删；本块已删 `inbox-station.mjs` / `quick-fix.mjs` / 判定行协议。
