...
#811 正文写「37 张」。GitHub `closed:>=2026-09-02 is:issue` 可复算（落笔时 34 张含 #797/#799/#801 完工关单）；差额主要是 #807 收编但仍 OPEN 的 Windows 层单（#699 #693 #686 #684 #683 等）。要精确名单：按关单时间搜，不要抄进另一份 md。
