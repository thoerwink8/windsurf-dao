...
| 10 | 派单流程验证收尾 | `host/skills/dispatch/SKILL.md` | 一单真实派工：卡 → 工人 → PR → 审官判绿 → land 合并，全程无人工干预 | **闸已开**（2026-09-04）：commander-act.timer enabled；指挥官自主派出 #815（成）与 #787（败→已按新机制报帅）；工人自建 PR #863。**剩最后一环**：#863 审官判绿 → 自动合并 |
