...
export function countLiveReviewers({ records, sessions } = {}) {
  ...
  for (const r of records) {
    ...
    if (typeof s.runDetail === 'string' && s.runDetail.trim()) continue;
