...
import { planWorkerDoneSend, readDispatchSettlement, isWrongPaneWorkerDoneError } from './dispatch/worker-done.mjs';
export { planWorkerDone, completeWorkerDoneNotify, pickWorkerDoneDispatchId, planWorkerDoneSend, readDispatchSettlement, isWrongPaneWorkerDoneError } from './dispatch/worker-done.mjs';
import { DEFAULT_DISPATCH_TYPE, REVIEWER_LABEL_PREFIX, pickModel, requireWorkerModel, collectIssueLabelsFromPr, resolveReviewerFromPr, listPrReviews, linkedIssueNumbers, isLiveDispatchRecipient } from './dispatch/reviewer.mjs';
export { DEFAULT_DISPATCH_TYPE, REVIEWER_LABEL_PREFIX, pickReviewer, pickModel, requireWorkerModel, collectIssueLabelsFromPr, resolveReviewerFromPr, listPrReviews, linkedIssueNumbers, REVIEWER_CREATE_OUTCOMES, collectReviewerCardsForPr, gateReviewerCreate, resolveReviewerReuse, classifyReviewerSpawnError, reviewerSpawnFailComment, isLiveDispatchRecipient } from './dispatch/reviewer.mjs';
import { worktreeSelMatches, findWorktreeBySel } from './dispatch/worktree.mjs';
export { occupyingAgents, resolveWorktreeSelector, planWorktreeRm, applyWorktreeRmPlan, formatStrayLedgerError, listStrayLedgerEvents, prepareWorktreeRm, worktreeSelMatches, findWorktreeBySel } from './dispatch/worktree.mjs';
export { extractTerminalText, classifyRead, verifyStarted, waitAndVerify, sleepSync, PASTED_CONTENT_RE, CURSOR_PASTE_RE, CURSOR_WORKING_RE, CURSOR_FOLLOWUP_RE, UNSUBMITTED_PASTE_REASON, isCursorStartChannel, stripCursorPasteResidue, cursorStartEvidence, unsubmittedPasteForStart, cursorUnsubmittedPaste, cursorFollowupEvidence, cursorUnsubmittedEvidence, pastedContentMatch, LEFTOVER_DISPATCH_RE, leftoverDispatchMatch, TUI_LOADING_RE, proofUnavailableReason, verifyInjection, verifyStartedPolling, verifyWorkerStarted } from './dispatch/inject.mjs';
import { hostProbeExec, runCapabilityProbes } from './dispatch/launch.mjs';
export { loadRoutingProviders, loadRouting, resolveLaunch, materializeLaunch, providerLaunchProblems, unwrapTerminalList, looksLikeAgentPreview, looksLikeShellPrompt, orcaKnownAgentId, launchCliModel, agentStartSpec, isReusableDefaultTerminal, findReusableDefaultTerminal, planLaunchFallback, terminalsAfterLaunchPlan, CODEX_CAPABLE_FLAG, PROBE_LABELS, PROBE_MARK_RE, probeMarkFound, assertCodexLaunch, assertReviewerLaunch, WRITE_PROBE_FILE, writeProbeScript, probeCommand, terminalProbeExec, runCapabilityProbes, hostProbeExec } from './dispatch/launch.mjs';
import {
  argsGateCreate, argsGateList, argsGateResolve, argsOrchestrationCheck, argsOrchestrationInbox,
  argsOrchestrationReply, argsOrchestrationSend, argsRunCreate, argsRunCreateSelf, argsRunCurrent,
  argsRunList, argsRunShow, argsRunUse, argsTaskCreate, argsTaskUpdate, argsTerminalClose,
  argsTerminalCreate, argsTerminalList, argsTerminalRead, argsTerminalSend, argsWorkerList,
  argsWorkerRead, argsWorkerRelease, argsWorkerShow, argsWorkerStart, argsWorkerStop,
  argsWorktreeCreate, argsWorktreePs, argsWorktreeRm, argsWorktreeSet, classifyNotifyTarget,
  commandKey, extractDispatchRunId, extractDispatchWorktreeId, extractRunId, extractSoldierTerminal,
...
export {
  ...
  argsWorkerRead, argsWorkerRelease, argsWorkerShow, argsWorkerStart, argsWorkerStop,
  argsWorktreeCreate, argsWorktreePs, argsWorktreeRm, argsWorktreeSet, classifyNotifyTarget,
  classifyWorkerStartSend, commandKey, encodeSendText, extractDispatchId, extractDispatchRunId,
  extractDispatchWorktreeId, extractHandleFromCreate, extractHandleFromWorkerStart, extractRunId,
  extractSoldierTerminal, extractTaskId, extractTerminalSend, extractWorktreeId,
  extractWorktreePath, findDispatchForTask, isRunRequired, newlineCodec, RUN_REQUIRED_HINT,
} from './dispatch/args.mjs';

// #768 拆分：共享常量/纯工具移到 scripts/lib/dispatch/constants.mjs（对外 API 不变）
import {
  DEFAULT_PROCESS_ALIVE_MS, DEFAULT_THINK_GRACE_MS, ESCAPE_LOG, HELP_FIXTURE_DIR, ROOT,
