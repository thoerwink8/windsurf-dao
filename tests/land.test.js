...
describe('land 决策层', () => {
  ...
  it('decideWorktreeRemove：每道闸单独拦得住', async () => {
    ...
    for (const [k, v] of [['merged', false], ['dirty', true], ['isMain', true], ['isCurrent', true], ['isDefaultBranch', true], ['executorManaged', true], ['mirasimManaged', true], ['mirasimUnprobed', true], ['detached', true]]) {
